...
export default function CustomerLayout() {
  ...
  const deliveryLocation = 
    ...
    profile?.city || 
    localUser.mohalla || 
    localProfile.mohalla ||
    "Civil Lines, Bareilly";

  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans w-full max-w-full overflow-x-hidden">
      ...
      <main className="flex-1 p-3 sm:p-6 max-w-[1750px] w-full mx-auto box-border overflow-x-hidden">
        <Outlet />
      </main>
    </div>
  );
